...
def load_bank():
    ...
    COMPAS_INPUT_FILE = "https://raw.githubusercontent.com/iosifidisvasileios/AdaFair/master/DataPreprocessing/bank-full.csv"
    ...
    print (collections.Counter(data[SENSITIVE_ATTRS[0]]))
